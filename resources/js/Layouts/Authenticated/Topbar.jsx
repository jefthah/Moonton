...
export default function Topbar() {
    // false = hidden (sesuai class awal "hidden" di markup)
    ...
    const triggerDropdown = () => {
        setDropdown((prev) => {
            ...
            if (dropdownTarget.current) {
                // next === true -> tampilkan (hapus hidden)
                if (next) dropdownTarget.current.classList.remove("hidden");
                else dropdownTarget.current.classList.add("hidden");
            }
            return next;
        });
    };
